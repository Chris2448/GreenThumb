/**************************************************************************************************
  Filename:       DeviceSelectActivity.java
...
public abstract class DeviceSelectActivity extends ViewPagerActivity {
	// Log
	...
	public static final String EXTRA_DEVICE = "ti.android.ble.sensortag.EXTRA_DEVICE";
	...
	// GUI
	private static DeviceSelectActivity mThis = null;
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		else if (itemId == R.id.opt_bt) {
			onBluetooth();
		}
		else if (itemId == R.id.opt_e2e) {
			onUrl(URL_FORUM);
		}
		else if (itemId == R.id.opt_sthome) {
			onUrl(URL_STHOME);
		}
		else if (itemId == R.id.opt_about) {
			onAbout();
		}
		else if (itemId == R.id.opt_exit) {
			finish();
		}
		else {
	...
	protected abstract Intent getDeviceActivityIntent();

	
	private void startDeviceActivity() {
		mDeviceIntent = getDeviceActivityIntent();
